...
const summaryGenerator = ref<typeof SummaryGenerator>();
...
const changeQuestionType = (question: IQuestion, to: string) => {
    ...
    if (to === "multiple-choice") {
        ...
        if (currentType === "multiple-choice") {
            (question as any as IMultipleAnswerQuestion).solution = [
                question.solution
            ];
        } else {
